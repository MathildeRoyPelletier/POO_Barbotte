namespace Barbotte
{
   public partial class Form1 : Form
   {
      ...
      private void RollDices()
      {
         ...
         lblDe2.Text = de2.ToString();

         numberOfRolls++;
         lblNombreLances.Text = numberOfRolls.ToString();
      ...
      private void onRollClick(object sender, EventArgs e)
      {
         ...
         if (numberOfRolls == 1)
         {
            ...
            {
               numberToReroll = total;
               lblNombreARefaire.Text = numberToReroll.ToString();
               lblMessage.Text = "Rebrassez";
            }
         ...
         else if (numberOfRolls > 1)
         {
            ...
            else if (total != 7 && total != numberToReroll)
            {
               lblMessage.Text = "Rebrassez";
            }
         }
